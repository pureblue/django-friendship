...
urlpatterns = patterns('',
    ...
    url(
        regex=r'^friends/(?P<user_id>\d+)/$',
        view=view_friends,
        name='friendship_view_friends',
    ),
    url(
        regex=r'^friend/add/(?P<to_user_id>\d+)/$',
    ...
    url(
        regex=r'^followers/(?P<user_id>\d+)/$',
        view=followers,
        name='friendship_followers',
    ),
    url(
        regex=r'^following/(?P<user_id>\d+)/$',
        view=following,
        name='friendship_following',
    ),
    url(
        regex=r'^follower/add/(?P<followee_user_id>\d+)/$',
        view=follower_add,
        name='follower_add',
    ),
    url(
        regex=r'^follower/remove/(?P<followee_user_id>\d+)/$',
